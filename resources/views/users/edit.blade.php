            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control @error('username') is-invalid @enderror" id="exampleInputUsername" placeholder="username" name="username" value="{{$user->username ?? old('username')}}">
                    ...
                    <div class="form-group">
                        <label for="exampleInputName">Peran Akun</label>
                        <select class="form-control @error('is_admin') is-invalid @enderror" aria-label="default select example" id="exampleInputName" name="is_admin" value="{{$user->is_admin ?? old('is_admin')}}">
